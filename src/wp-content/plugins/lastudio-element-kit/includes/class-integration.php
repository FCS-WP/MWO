...
if (! class_exists('LaStudio_Kit_Integration')) {
    ...
    class LaStudio_Kit_Integration
    {
        ...
        public function init()
        {
            ...
            add_action('elementor/controls/register', array($this, 'rewrite_controls'), 10);
        ...
        public function register_vendor_addons($widgets_manager)
        {
            ...
            foreach ($allowed_vendors as $vendor) {
                if (
                    is_callable($vendor['conditional']['cb'])
        ...
        {
            if (true || !lastudio_kit()->get_theme_support('lastudio-kit')) {
...
.lakit-vheader--hide__DEVICE__.lakit--is-vheader.lakit-vheader-pleft > .elementor-location-header > .elementor-section-wrap > .elementor-top-section:first-child,
.lakit-vheader--hide__DEVICE__.lakit--is-vheader.lakit-vheader-pleft > .elementor-location-header > .elementor-top-section:first-child {
  left: 0
}
.lakit-vheader--hide__DEVICE__.lakit--is-vheader.lakit-vheader-pright > .elementor-location-header > .elementor-section-wrap > .elementor-top-section:first-child,
.lakit-vheader--hide__DEVICE__.lakit--is-vheader.lakit-vheader-pright > .elementor-location-header > .elementor-top-section:first-child {
  right: 0
}
.lakit-vheader--hide__DEVICE__.lakit--is-vheader > .elementor-location-header > .elementor-section-wrap > .elementor-top-section:first-child > .e-con-inner,
.lakit-vheader--hide__DEVICE__.lakit--is-vheader > .elementor-location-header > .elementor-top-section:first-child > .e-con-inner{
  height: auto;
  position: sticky;
...
.lakit-vheader--hide__DEVICE__.lakit--is-vheader > .elementor-location-header > .elementor-section-wrap > .elementor-top-section:first-child > .elementor-container,
.lakit-vheader--hide__DEVICE__.lakit--is-vheader > .elementor-location-header > .elementor-top-section:first-child > .elementor-container {
  flex-flow: row wrap;
  height: auto;
  position: sticky;
  top: var(--lakit-adminbar-height);
...
.lakit-vheader--hide__DEVICE__.lakit--is-vheader > .elementor-location-header > .elementor-section-wrap > .elementor-top-section:first-child > .elementor-container > .elementor-column,
.lakit-vheader--hide__DEVICE__.lakit--is-vheader > .elementor-location-header > .elementor-top-section:first-child > .elementor-container > .elementor-column {
  width: 100%
}
...
";
        ...
        public function ajax_newsletter_subscribe($request)
        {
            ...
            if (
                isset($request['use_target_list_id']) &&
        ...
        {
            $custom_css = lastudio_kit_settings()->get('custom_css', '');
        ...
        public function ajax_login_handle($request)
        {
            ...
            if (is_wp_error($signon)) {
                return [
                    'type'      => 'error',
                    'message'   => 'We couldn’t find an account with that info.',
